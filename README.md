...
- **Production Case Studies with Real Screenshots**:
  ...
  - **Video Management System (VMS) & PTZ Engine**: Full ONVIF integration (WS-Discovery, media profiles), real-time PTZ camera control, and sub-200ms WebRTC/RTSP multi-camera timeline playback.
  - **Edge ANPR & Traffic Classifier (ATCC)**: Raspberry Pi 5 embedded vision with YOLOv8, PaddleOCR, and ByteTrack ([Live Hugging Face Demo](https://huggingface.co/spaces/parthpatil0024/ANPR)).
...
└── assets/
    ...
    ├── microsoft-certified-fundamentals-badge.svg ← Azure Certification Badge
    ├── ParkAOT/                               ← 7 Production screenshots (POS, ANPR, Tariff, Thermal Slip)
    ├── ANPR_Central_monitoring/               ← 4 Multi-lane central monitoring screenshots
    ├── vehicle_reid/                          ← 3 Deep Learning Re-ID screenshots (Embeddings, FAISS Search)
    ├── NEXTGEN/                               ← 8 ATMS & Highway GIS command screenshots
    ├── Video_management/                      ← 7 VMS & Playback timeline screenshots
    ├── ATCC/                                  ← Real-time vehicle classification & counting screenshots
    └── ATMS_PWA/                              ← 4 Mobile PWA field diagnostic screenshots
```

## 🛠️ Tech Stack

- **Frontend**: HTML5, Vanilla CSS3 (Custom Design System, Glassmorphism, CSS Grid & Flexbox), ES6+ JavaScript.
- **Libraries & CDN Assets**: [Three.js r128](https://threejs.org/) (ambient particle network), [Font Awesome 6.5.1](https://fontawesome.com/) (icons), [Google Fonts](https://fonts.google.com/).
- **Deployment**: Ready for instant deployment on GitHub Pages, Netlify, or Vercel.

## 💻 Local Preview

Simply double-click `index.html` or open it in any web browser. No `npm install` or local servers required.

## 📄 License

MIT © 2026 Parth Patil
